...
function modernaChangeVcDate(elem){
	...
	if(data.order_lot_system.indexOf('moderna')!=-1){
		openModal("กรุณากดยืนยัน",'<b style="color:red; font-size:20px;">ท่านสามารถเลื่อนนัดได้ตลอดก่อนถึงวันฉีดจริง 48 ชม.</b><br/><br/><img src="https://cdn.jsdelivr.net/gh/pop-itsmartone/service-cdn@main/image/คำแนะนำ_moderna_2.jpg" style="max-width:100%" />',true,function(){
			hideModal();
...
function modernaChangeReceiver(elem){
	...
	if(data.order_lot_system.indexOf('moderna')!=-1){
		openModal("กรุณากดยืนยัน",'<b style="color:red; font-size:20px;">ท่านสามารถโอนสิทธิ์ได้เพียง 1 ครั้งเท่านั้น</b><br/><br/><img src="https://cdn.jsdelivr.net/gh/pop-itsmartone/service-cdn@main/image/คำแนะนำ_moderna_2.jpg" style="max-width:100%" />',true,function(){
			hideModal();
