...
function checkCovidShowResult(){
	...
	for(var i in result_list){
  	...
  	info.url = URL.createObjectURL(b64toBlob(info.base64, 'application/pdf'));
		...
		3.EQUIVOCAL
		*/
		if($.inArray(lab_result_l, ["detect", "detected", "undetected", "undetectable"
        	...
        	"mData" : null, "sClass": "center",
					"mRender": function ( data, type, full ) {
						var returnHtml= '<div class="btn-group">'
		            		...
		            		if(full.vaccine_status_id!='D'){
		            			returnHtml+='<li><a href="#" onclick="vaccineMonitorSetStatus(\''+full.vaccine_moderna_id+'\',\'D\'); return false;"><span>ใช้แพ็คเกจ</span></a></li>';
			            	}
		            		if(full.vaccine_status_id!='W'){
