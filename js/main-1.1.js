...
//report-vat_s
function validateReportVatS(){
	var passValidate=true;
	//check input bottom up
	passValidate=checkInputTypeText($("input[id=inputFilterPeriod]")) && passValidate;
	return passValidate;
}
if(viewName=="report-vat_s"){
			...
			"aoColumns": [
	            ...
	            { 	"mData" : null,
					"mRender": function ( data, type, full ) {
						return full.tax_date;
					} 
				},
	            { 	"mData" : null,
					"mRender": function ( data, type, full ) {
						return full.tax_doc_no;
					}
				},
	            { 	"mData" : null,
					"mRender": function ( data, type, full ) {
						return full.payer_name;
					}
				},
	            { 	"mData" : null,
					"mRender": function ( data, type, full ) {
	            ...
	            { 	"mData" : null,
					"mRender": function ( data, type, full ) {
						return full.tax_branchcode;
					} 
				},
	            { 	"mData" : null, "sClass": "right",
					"mRender": function ( data, type, full ) {
						return convertToMoneyFormat(full.base);
					}
				},
	            { 	"mData" : null, "sClass": "right",
					"mRender": function ( data, type, full ) {
						return convertToMoneyFormat(full.amt);
					}
				},
	            { 	"mData" : null,
					"mRender": function ( data, type, full ) {
